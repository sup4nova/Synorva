...
# Extracts acoustic features from an audio file and returns them as a flat dict.
# These numbers are used by label_audio_emotions.py to compute valence and arousal.
# Converts a WAV or MP3 into a row of ~30 numeric columns.
